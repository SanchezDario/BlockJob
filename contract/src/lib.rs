/*
 * Marketplace de servicios profesionales con modalidad freelance
 * @Autores: Calle Galarza, Eliana; Sánchez, Darío Fabián
*/

// Importación del contrato 'mediator' para tratar apelaciones
mod mediator;
...
pub struct Users {
    ...
    ee: HashMap<String, Employee>,
    // Mapa de empleadores
    er: HashMap<String, Employer>,
}

#[derive(BorshSerialize, BorshStorageKey)]
// Estructura que almacena las categorias, posteriormente se crearán subcategorias clasificadas según idioma
...
#[derive(BorshSerialize, BorshStorageKey)]
// Estructura que almacena los profesionales y su metadata
pub struct Employee {
    id: ValidAccountId,
    category: String,
    degree: bool, 
...
#[derive(BorshSerialize, BorshStorageKey)]
// Estructura que almacena los empleadores y su metadata
pub struct Employer {
    id: ValidAccountId,
    category: String,
    points: u8,
...
impl Contract {
    ...
    pub fn nft_mint(
        ...
        self.service.mint(token_id, receiver_id, Some(token_metadata))
    }
...
impl Users{
    ...
    pub fn new_professional(&mut self, account_id: ValidAccountId, 
        ...
        let user_id = bs58::encode(env::sha256(&env::random_seed())).into_string();
        //let user = nickname;
    ...
    pub fn new_employer(&mut self, account_id: ValidAccountId, category: String ) {
        //let creator = env::signer_account_id();
        let user_id = bs58::encode(env::sha256(&env::random_seed())).into_string();
